...
public class SwordBasePlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == PigBasemodModItems.SHARP_BLADE.get()) {
			...
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(PigBasemodModItems.SWORD_SHARP.get()).copy();
