package net.mcreator.pigbasemod;
...
@Mod("pig_basemod")
public class PigBasemodMod {
	public static final Logger LOGGER = LogManager.getLogger(PigBasemodMod.class);
	public static final String MODID = "pig_basemod";

	public PigBasemodMod() {
