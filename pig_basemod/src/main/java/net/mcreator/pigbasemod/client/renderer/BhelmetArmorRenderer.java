...
import net.mcreator.pigbasemod.item.model.BhelmetModel;
import net.mcreator.pigbasemod.item.BhelmetItem;

public class BhelmetArmorRenderer extends GeoArmorRenderer<BhelmetItem> {
	public BhelmetArmorRenderer() {
		super(new BhelmetModel());
	...
	@Override
	public RenderType getRenderType(BhelmetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
