...
public class MinionEntity extends Monster {
	public MinionEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PigBasemodModEntities.MINION.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pig_basemod:minionambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pig_basemod:minionhurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pig_basemod:miniondie"));
	}
