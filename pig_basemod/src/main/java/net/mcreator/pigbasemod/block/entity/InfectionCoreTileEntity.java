package net.mcreator.pigbasemod.block.entity;
...
public class InfectionCoreTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public InfectionCoreTileEntity(BlockPos pos, BlockState state) {
		super(PigBasemodModBlockEntities.INFECTION_CORE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(InfectionCoreBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<InfectionCoreTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<InfectionCoreTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("infection_core");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Infection Core");
	}
