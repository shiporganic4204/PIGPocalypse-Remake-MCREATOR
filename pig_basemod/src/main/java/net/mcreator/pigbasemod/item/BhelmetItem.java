...
import net.mcreator.pigbasemod.client.renderer.BhelmetArmorRenderer;

import java.util.function.Consumer;
import java.util.List;

public class BhelmetItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public BhelmetItem(ArmorItem.Type type, Item.Properties properties) {
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new BhelmetArmorRenderer();
